...
const AllProduct = () => {
    ...
    const editProduct = async (pId, product, type) => {
        if (type) {
            dispatch({ type: "editProdutcModalOpen", product: { ...product, pId: pId } })
        }
    }
    ...
    return (
        <>
            <div className="col-span-1 overflow-auto bg-whtie shadow-lg p-4">
                <table className="table-auto border w-full my-2">
                    ...
                    <tbody>
                        {products && products.length > 0 ? (
                            ...
                            <tr>
                                <td colSpan="10" className="text-xl text-center font-semibold py-8">No product found</td>
                            </tr>
                        )}
                    </tbody>
                </table>
