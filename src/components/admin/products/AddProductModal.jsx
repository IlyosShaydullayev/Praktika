    ...
    return (
        <>
            ...
            <div className={`${data.addProductModal ? "" : "hidden"} fixed inset-0 flex items-center z-30 justify-center overflow-auto`}>
                <div className="mt-32 md:mt-0 relative bg-white w-11/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4 p-4 md:px-8">
                    ...
                    <form className="w-full" onSubmit={(e) => submitForm(e)}>
                        ...
                        <div className="flex space-x-1 py-4">
                            ...
                            <select name="status" id="status" value={fData.pStatus} onChange={(e) => setFdata({ ...fData, error: false, success: false, pStatus: e.target.value })} className="px-4 py-2 border focus:outline-none">
                        ...
                        <div className="flex flex-col space-y-1 w-full pb-4 md:pb-6 mt-4">
                            <button className="rounded-full bg-gray-800 text-gray-100 text-lg font-medium py-2">Create product</button>
                        </div>
                    </form>
                </div>
            </div>
