            ...
            <div className="col-span-1 overflow-auto bg-white shadow-lg p-4">
                    ...
                    <tbody>
                        {data.totalOrders.Orders !== undefined ? (
                            ordersList().map((item, i) => {
                                return <TodayOrderTable order={item} key={i} />
                            })
                        ) : (
                            <tr>
                ...
                <div className="flex justify-center">
                    <span
                        ...
                        className="cursor-pointer px-4 py-2 text-white rounded-full bg-[#303031]"
                    >View All</span>
                </div>
            </div>
        </>
        ...
        <>
            <tr>
                ...
                <td className="p-2 text-left">
                    {order.allProduct.map((item, i) => (
                        <img src={item.id.pImages[0].url} key={i} alt="Pic" />
                    ))}
                </td>
